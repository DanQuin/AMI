...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mStartRestablecerPassActivity = (Button) findViewById(R.id.login_start_restablecerPassActivity);
        mStartRestablecerPassActivity.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginActivity.this,RestablecerPassActivity.class));
            }
        });
